...
public class ImovelService {
    ...
    public Imovel getById(Long id) {
        return imovelRepository.findById(id).orElseThrow(() -> new RegistroNotFoundException(id));
    }

    public Imovel getByNumero(String numero) {
        return imovelRepository.findFirstByNumero(numero).orElseThrow(() -> new RegistroNotFoundException(numero));
    }
